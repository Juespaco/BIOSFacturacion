CREATE TABLE [dbo].[CentroOperativo](
	...
	[FechaPrimerCobro] [datetime] NOT NULL,
	[FechaSegundoCobro] [datetime] NOT NULL,
	[FechaCobroPNC] [datetime] NOT NULL,
	[DefinicioPrimerCobro] [int] NOT NULL,
	[DefinicioSegundoCobro] [int] NOT NULL,
